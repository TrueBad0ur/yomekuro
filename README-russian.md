...
фильтры по жанрам/тегам — в шапке.
...
Настройки → Uploading: выберите библиотеку, перетащите в область загрузки
...
### Конвертация (только для администраторов)

Настройки → Converting показывает все книги, уже имеющиеся в библиотеках,
по томам:
...
Settings → Uploading: выберите библиотеку, файл и имя. Файл — либо архив
...
затрагиваются, пока их не переконвертируют заново (Settings → Converting →
Reconvert).
