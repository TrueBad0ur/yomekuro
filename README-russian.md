...
архивы с исходными изображениями страниц и/или PDF, и укажите имя. **Можно
выбрать сразу несколько файлов** — каждый станет отдельной задачей конвертации,
и они встанут в очередь.
